...
public class PortfolioActivity_RAdapter extends RecyclerView.Adapter<PortfolioActivity_RAdapter.myViewHolder> {
    Drawable drawable;
    private Context context;
    private List<ViewFixed_ListItem> viewFixed_listItemList;

    public PortfolioActivity_RAdapter(Context context, List<ViewFixed_ListItem> viewFixed_listItemList) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_portfolio_rview, parent, false);
    ...
    public class myViewHolder extends RecyclerView.ViewHolder {
        ...
        /*Min Amount*/
        TextView tv_dName, tv_netpl, tv_einvestmentAmount, tv_ecurrentValue, tv_eplv;
        ImageView iv_logo;

        public myViewHolder(View itemView) {
            super(itemView);
            iv_logo=(ImageView)itemView.findViewById(R.id.iv_logo);
            tv_dName = (TextView) itemView.findViewById(R.id.tv_Equity);
            tv_netpl = (TextView) itemView.findViewById(R.id.tv_netpl);
            tv_einvestmentAmount = (TextView) itemView.findViewById(R.id.tv_einvestmentAmount);
            tv_ecurrentValue = (TextView) itemView.findViewById(R.id.tv_ecurrentValue);
            tv_eplv = (TextView) itemView.findViewById(R.id.tv_eplv);
        }
    }
}
